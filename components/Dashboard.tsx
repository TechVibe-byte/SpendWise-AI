...
const Dashboard: React.FC<DashboardProps> = ({ 
  ...
  const budgetBadgeColor = useMemo(() => {
    if (budgetUtilization >= 100) return 'bg-red-50 text-red-700 dark:bg-red-950/40 dark:text-red-400';
    if (budgetUtilization >= 95) return 'bg-orange-50 text-orange-700 dark:bg-orange-950/40 dark:text-orange-400';
